---
template: onboarding
spec-link: openspec/specs/template-onboarding/spec.md
---

# Generator Prompt: Onboarding "Welcome to the Universe"

Render per `openspec/specs/template-onboarding/spec.md`.
...
## Voice
Warm but spec-clear. Think "welcome to the studio's universe," not "onboarding checklist."
