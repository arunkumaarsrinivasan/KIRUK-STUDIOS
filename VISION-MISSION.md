...
Polymath, tool-bending founders who want a world that doesn't exist yet. Budget flexible; ambition fixed. They prefer Loom walkthroughs to Gantt charts.

## Disqualified Client

"Make it look like [trendy product]." "Can you clone Y?" "Our timeline is aggressive — just apply the template." Decline with grace, refer elsewhere.
...
Re-read this file on the **1st of every month**. If anything reads stale or untrue, propose an edit via `openspec/changes/vision-update-<date>/`, validate, apply, then update `CHANGELOG.md`.
