    ...
    <main className="bg-paper relative min-h-[100svh] w-full px-6 py-10 md:px-10">
      ...
      <header className="relative mb-6 flex items-center gap-3">
        ...
        <div className="leading-none">
          <h1 className="brutal text-ink text-4xl">{u.title} — proposal</h1>
          <p className="handwritten text-pencil text-sm">scribble the pitch · {slug}</p>
        </div>
      </header>
