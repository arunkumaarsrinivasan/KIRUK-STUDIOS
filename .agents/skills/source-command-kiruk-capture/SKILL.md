---
name: 'source-command-kiruk-capture'
description: "Flush current session's creative decisions into ideas/log.ndjson. Offer to promote ideas ready for OpenSpec."
---

# source-command-kiruk-capture

Use this skill when the user asks to run the migrated source command `kiruk-capture`.
...
4. Redact secrets per `idea-capture/spec.md` (sk-_, ghp\__, AKIA\*, password/secret/api_key assignments).
